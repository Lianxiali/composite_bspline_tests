                   ...
                   void* /*ctx*/)
{
    ...
    if (struct_list[strct_num].compare("pipe") == 0)
    {
        ...
        for(int i=0; i< int(num_vertices/2); i++)
        {
            ...
            vertex_posn[i][1] = H/2 + D/2 ;
            vertex_posn[i+num_vertices][0] = i*ds;
            vertex_posn[i+num_vertices][1] = H/2 - D/2 ;
        }
    }
